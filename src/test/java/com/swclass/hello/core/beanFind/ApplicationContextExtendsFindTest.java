package com.swclass.hello.core.beanFind;
...
public class ApplicationContextExtendsFindTest {
    ...
    @Test
    @DisplayName("부모 타입으로 조호시, 자식들이 같이 있어서 중복 오류 발생.")
    ...
    @Test
    @DisplayName("부모 타입으로 조호시, 자식들이 같이 있으면 Name으로 조회")
    void findByBeanTypeBeanName() {
